            ...
            <div class="pl-6 bg-gray-200 w-48 h-screen border-r-2 border-gray-400">
                <nav class="pt-6">
                    ...
                    <router-link to="/contacts/create" class="flex items-center py-2 hover:text-blue-600 text-sm">
                        ...
                        <div class="tracking-wide pl-3">Add Contact</div>
                    </router-link>
            ...
            <div class="flex flex-col flex-1 h-screen overflow-y-hidden">
                <div class="h-16 px-6 border-b border-gray-400 flex items-center justify-between">
                    ...
                    <div class="flex items-center">
                        <SearchForm />
                        <UserNameCircle :fullName="user.first_name + ' ' + user.last_name"/>
                    </div>
                </div>
                <div class="flex flex-col overflow-y-hidden flex-1">
                    <router-view class="p-6 overflow-x-hidden">Content here</router-view>
                </div>
            </div>
        </div>
...
<script>
    ...
    export default {
        name: "App",
        components: {UserNameCircle, SearchForm},
        data() {
            return {
                title: ''
            }
        ...
        watch: {
            ...
            title(newValue, oldValue) {
                document.title = this.title + ' | SimpleContacts';
            }
        },
    }
</script>
