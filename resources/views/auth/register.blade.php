    ...
    <div class="mx-auto h-full flex justify-center items-center bg-gray-300">
        <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
            ...
            <form method="POST" action="{{ route('register') }}" class="pt-8">
                ...
                <div class="relative">
                    <label for="first_name" class="uppercase text-blue-500 text-xs font-bold absolute pl-3 pt-2">First Name</label>
                ...
                <div class="relative pt-3">
                    <label for="last_name" class="uppercase text-blue-500 text-xs font-bold absolute pl-3 pt-2">Last Name</label>
                ...
                <div class="relative pt-3">
                    <label for="other_names" class="uppercase text-blue-500 text-xs font-bold absolute pl-3 pt-2">Last Name</label>
                ...
                <div class="relative pt-3">
                    <label for="phone_number" class="uppercase text-blue-500 text-xs font-bold absolute pl-3 pt-2">Company</label>
                ...
                <div class="relative pt-3">
                    <label for="company" class="uppercase text-blue-500 text-xs font-bold absolute pl-3 pt-2">Company</label>
